  ...
  <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
      ...
      <label class="block" for="dest">Enter Date of Departure</label></div>
                ...
                <div class="relative">
                  ...
                  <input datepicker="" name="doj" datepicker-buttons="" type="text" formaction="tickets.php" formmethod="post" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input" placeholder="Select date">
                  </div>
