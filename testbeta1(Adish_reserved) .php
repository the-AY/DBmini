testing create new account page
(register.php/newac.html)

INSERT VALUE TO C_ID AND PASSWORD WHILE CREATING
INSERT INTO `customer` (`C_ID`, `C_NAME`, `AGE`, `ADDRESS`, `GENDER`, `CONTACT`, `PASSWORD`) VALUES ('', NULL, NULL, NULL, NULL, NULL, '') 
<?php
session_start();
